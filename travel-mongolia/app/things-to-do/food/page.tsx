...
export default function FoodPage() {
  ...
  const filteredSpots =
    activeTab === 'all'
      ? FOOD_SPOTS
      : FOOD_SPOTS.filter((spot) => spot.categoryKey === activeTab);
      ...
      <section className="relative bg-neutral-900 text-white py-24 px-6 sm:px-12 lg:px-20 overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight mt-3 mb-4">
            Хоол, ундааны туршлага
          </h1>
          <p className="text-base sm:text-lg text-neutral-300 max-w-2xl font-light leading-relaxed">
            Нүүдэлчдийн шим тэжээлт мах, сүүн идээ, уламжлалт хорхог, шимийн айраг болон нутаг нутгийн давтагдашгүй амтыг мэдрэх аяллууд.
          </p>
        </div>
      </section>

     {/* Шүүлтүүрийн мөр (Голлосон бүтэцтэй) */}
      <div className="sticky top-0 z-40 bg-white border-b border-neutral-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative flex items-center justify-center py-3.5">
          {/* Зүүн сум */}
          <button
            type="button"
            onClick={() => scroll('left')}
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 mt-10">
        <div className="flex justify-between items-end mb-6">
          <p className="text-xs text-neutral-500 font-semibold uppercase tracking-wider">
            Нийт {filteredSpots.length} амталгаа, хоолны туршлага олдлоо
          </p>
        </div>
