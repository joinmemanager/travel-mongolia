...
export const CULTURE_SPOTS: CultureSpot[] = [
  {
    ...
    description:
      'Эртний нийслэл Хархорум хотын туурин дээр сүндэрлэсэн Монголын анхны буддын шашны хийд.',
  },
  {
    ...
    description:
      'Дэлхийн хамгийн том морьт хөшөө ба доторх түүхийн үзмэр, алтан ташуур домогт нутаг.',
  },
  {
    ...
    description:
      'Түрэг, Уйгар, Их Монгол гүрний төв болж байсан ЮНЕСКО-ийн дэлхийн өвд бүртгэлтэй түүхэн хөндий.',
  },
  {
    ...
    description:
      'Монголын хаад язгууртны 10,000 гаруй эх олдвор, үзмэрийг дэглэсэн олон улсын жишиг бүхий музей.',
  },
  {
    ...
    description:
      'Эртний далайн ёроол бүхий байгалийн цав цамхаг ба палеолитын үеийн чулуун зэвсгийн суурин.',
  },
  {
    ...
    description:
      'Монгол ардын язгуур аялгуу, аялгуут исгэрээ, хөөмэйн тоглолт болон хуур урлалын туршлага.',
  },
];
