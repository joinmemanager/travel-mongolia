...
export const WELLNESS_SPOTS: WellnessSpot[] = [
  {
    ...
    description:
      'Өндөр гэгээн Занабазарын бясалгаж, Соёмбо үсгийг зохиосон өндөр хадан хясаан дээрх сүнслэг дагшин орон.',
  },
  {
    ...
    description:
      'Ой модон дундах байгалийн халуун рашаанд орж алжаал тайлах, эрүүл мэндээ нөхөн сэргээх спа амралт.',
  },
  {
    ...
    description:
      'Ноён хутагт Данзанравжаагийн байгуулсан Шамбалын орон, хүсэл биелүүлэгч тахилгат хайрхан, дотоод хүчээ сэлбэх орон зай.',
  },
  {
    ...
    description:
      'Өглөөний цэнгэг агаарт уулын бэлд иог хийж, оюун санаагаа цэгцлэн бие бялдраа сэргээх хөтөлбөр.',
  },
  {
    ...
    description:
      'Байгальтайгаа хүйн холбоотой дархад, цаатан удган зарингуудын зан үйл, эртний тахилгатай танилцах хүндэтгэлийн туршлага.',
  },
  {
    ...
    description:
      'Интернэт, утасны сүлжээнээс бүрэн тасарч, одот тэнгэр, элсэн манхан дунд жинхэнэ нам гүмийг мэдрэх өвөрмөц амралт.',
  },
];
