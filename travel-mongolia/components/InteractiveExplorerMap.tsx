...
export const AIMAG_CENTERS: Record<string, { center: [number, number]; zoom: number }> = {
  ...
  'Говь-Алтай': { center: [45.7500, 96.2500], zoom: 7 },
  'Говьсүмбэр': { center: [46.4950, 108.5700], zoom: 9 },
  ...
  'Өвөрхангай': { center: [45.7500, 102.7800], zoom: 8 },
  'Өмнөговь': { center: [43.5658, 104.4250], zoom: 7 },
  'Сүхбаатар': { center: [46.6833, 113.2833], zoom: 7 },
  'Сэлэнгэ': { center: [50.1142, 106.2078], zoom: 8 },
  'Төв': { center: [47.5000, 106.5000], zoom: 8 },
  'Увс': { center: [49.9811, 92.0667], zoom: 7 },
  'Ховд': { center: [48.0056, 91.6419], zoom: 7 },
  'Хөвсгөл': { center: [50.0000, 100.1600], zoom: 7 },
      ...
      const customIcon = L.divIcon({
        ...
        html: `
          <div style="
            ...
            font-weight: 800;
          ">
            ${place.category === 'camp' ? '⛺' : place.category === 'food' ? '☕' : place.category === 'culture' ? '🏛' : '🏔'}
          </div>
        `,
