...
const PROTECTED_DATA: CategorySection[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: 'Гүн Галуут',
        imageUrl: 'https://images.unsplash.com/photo-1511497584788-87676104235f?q=80&w=800',
      },
      {
        title: 'Угтам уул',
        imageUrl: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?q=80&w=800',
    ...
    cards: [
      {
        ...
        imageUrl: 'https://images.unsplash.com/photo-1472214103451-9374bd1c798e?q=80&w=1200',
        isWide: true,
      },
      {
...
export default function ProtectedShowcase({ defaultSlug }: { defaultSlug?: string }) {
  const [activeTab, setActiveTab] = useState<string>(defaultSlug || PROTECTED_DATA[0].id);
    ...
    <div className="w-full bg-white">
      ...
      <section className="relative w-full h-[55vh] min-h-[420px] max-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-6xl md:text-7xl font-sans font-bold text-white tracking-tight drop-shadow-md">
