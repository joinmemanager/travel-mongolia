...
const PROVINCES: ProvinceData[] = [
  ...
  {
    id: 'bayan-olgii',
    name: { mn: 'Баян-Өлгий аймаг', en: 'Bayan-Ulgii', ru: 'Баян-Улгий', zh: '巴彦乌列盖省', ja: 'バヤン・ウルギー県', ko: '바얀울기' },
    description: {
  ...
  {
    id: 'uvs',
    name: { mn: 'Увс аймаг', en: 'Uvs', ru: 'Увс', zh: '乌布苏省', ja: 'オブス県', ko: '옵스' },
    description: {
  ...
  {
    id: 'khovd',
    name: { mn: 'Ховд аймаг', en: 'Khovd', ru: 'Ховд', zh: '科布多省', ja: 'ホブド県', ko: '홉드' },
    description: {
  ...
  {
    id: 'zavkhan',
    name: { mn: 'Завхан аймаг', en: 'Zavkhan', ru: 'Завхан', zh: '扎布汗省', ja: 'ザブハン県', ko: '자브항' },
    description: {
  ...
  {
    id: 'govi-altai',
    name: { mn: 'Говь-Алтай аймаг', en: 'Govi-Altai', ru: 'Говь-Алтай', zh: '戈壁阿尔泰省', ja: 'ゴビ・アルタイ県', ko: '고비알타이' },
    description: {
    ...
    images: ['https://images.unsplash.com/photo-1509316975850-ff9c5deb0cd9?q=80&w=800&auto=format&fit=crop'],
  ...
  {
    id: 'hovsgol',
    name: { mn: 'Хөвсгөл аймаг', en: 'Khuvsgul', ru: 'Хубсугул', zh: '库苏古尔省', ja: 'フブスグル県', ko: '홉스골' },
    description: {
  ...
  {
    id: 'arkhangai',
    name: { mn: 'Архангай аймаг', en: 'Arkhangai', ru: 'Архангай', zh: '后杭爱省', ja: 'アルハンガイ県', ko: '아르항가이' },
    description: {
  ...
  {
    id: 'bulgan',
    name: { mn: 'Булган аймаг', en: 'Bulgan', ru: 'Булган', zh: '布尔干省', ja: 'ボルガン県', ko: '불강' },
    description: {
    ...
    images: ['https://images.unsplash.com/photo-1516483638261-f4dbaf036963?q=80&w=800&auto=format&fit=crop'],
    svgPoint: { x: 505, y: 165 }
  },
  {
    id: 'orkhon',
    name: { mn: 'Орхон аймаг', en: 'Orkhon', ru: 'Орхон', zh: '鄂尔浑省', ja: 'オルホン県', ko: '오르홍' },
    description: {
  ...
  {
    id: 'selenge',
    name: { mn: 'Сэлэнгэ аймаг', en: 'Selenge', ru: 'Сэлэнгэ', zh: '色楞格省', ja: 'セレンゲ県', ko: '셀렝게' },
    description: {
    ...
    images: ['https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?q=80&w=800&auto=format&fit=crop'],
    svgPoint: { x: 575, y: 115 }
  },
  {
    id: 'darkhan-uul',
    name: { mn: 'Дархан-Уул аймаг', en: 'Darkhan-Uul', ru: 'Дархан-Уул', zh: '达尔汗乌拉省', ja: 'ダルハン・オール県', ko: '다르항올' },
    description: {
    ...
    images: ['https://images.unsplash.com/photo-1578922746465-3a80a228f223?q=80&w=800&auto=format&fit=crop'],
  ...
  {
    id: 'ulaanbaatar',
    name: { mn: 'Улаанбаатар хот', en: 'Ulaanbaatar', ru: 'Улан-Батор', zh: '乌兰巴托', ja: 'ウランバートル', ko: '울란바토르' },
    description: {
  ...
  {
    id: 'tuv',
    name: { mn: 'Төв аймаг', en: 'Tuv', ru: 'Төв', zh: '中央省', ja: 'トゥブ県', ko: '티브' },
    description: {
  ...
  {
    id: 'uvurkhangai',
    name: { mn: 'Өвөрхангай аймаг', en: 'Uvurkhangai', ru: 'Уверхангай', zh: '前杭爱省', ja: 'ウブルハンガイ県', ko: '우부르항가이' },
    description: {
  ...
  {
    id: 'bayankhongor',
    name: { mn: 'Баянхонгор аймаг', en: 'Bayankhongor', ru: 'Баянхонгор', zh: '巴彦洪戈尔省', ja: 'バヤンホンゴル県', ko: '바얀홍고르' },
    description: {
  ...
  {
    id: 'dundgovi',
    name: { mn: 'Дундговь аймаг', en: 'Dundgovi', ru: 'Дундговь', zh: '中戈壁省', ja: 'ドンドゴビ県', ko: '둔드고비' },
    description: {
  ...
  {
    id: 'omnogovi',
    name: { mn: 'Өмнөговь аймаг', en: 'Umnugovi', ru: 'Южное Гоби', zh: '南戈壁省', ja: '南ゴビ県', ko: '옴노고비' },
    description: {
  ...
  {
    id: 'dornogovi',
    name: { mn: 'Дорноговь аймаг', en: 'Dornogovi', ru: 'Восточное Гоби', zh: '东戈壁省', ja: '東ゴビ県', ko: '도르노고비' },
    description: {
  ...
  {
    id: 'govisumber',
    name: { mn: 'Говьсүмбэр аймаг', en: 'Govisumber', ru: 'Говьсумбэр', zh: '戈壁苏木贝尔省', ja: 'ゴビスムベル県', ko: '고비스음베르' },
    description: {
  ...
  {
    id: 'khentii',
    name: { mn: 'Хэнтий аймаг', en: 'Khentii', ru: 'Хэнтий', zh: '肯特省', ja: 'ヘンティー県', ko: '헹티' },
    description: {
  ...
  {
    id: 'sukhbaatar',
    name: { mn: 'Сүхбаатар аймаг', en: 'Sukhbaatar', ru: 'Сүхбаатар', zh: '苏赫巴托尔省', ja: 'スフバートル県', ko: '수흐바타르' },
    description: {
  ...
  {
    id: 'dornod',
    name: { mn: 'Дорнод аймаг', en: 'Dornod', ru: 'Дорнод', zh: '东方省', ja: 'ドルノド県', ko: '도르노드' },
    description: {
...
export default function RegionMap() {
  ...
  const localizedDesc = activeProvince.description[locale] || activeProvince.description.mn;

  // Текстийн уртад тохируулан шошгоны өргөнийг хангалттай урт тооцно
  const badgeWidth = Math.max(160, localizedName.length * 15 + 40);

  return (
    <section id="places" className="py-24 bg-[#f8f9fa] border-t border-gray-200 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          {/* ЗҮҮН ТАЛ */}
          <div className="lg:col-span-5 bg-neutral-900 rounded-3xl overflow-hidden shadow-2xl text-white relative flex flex-col justify-between">
            <div className="relative h-64 sm:h-72 w-full bg-black">
              ...
              <button
                onClick={handlePrev}
                aria-label="Өмнөх"
                className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-black/60 hover:bg-[#15803d] text-white flex items-center justify-center transition-all z-10 backdrop-blur-sm cursor-pointer shadow-lg"
              >
                ‹
              </button>
              <button
                onClick={handleNext}
                aria-label="Дараах"
                className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-black/60 hover:bg-[#15803d] text-white flex items-center justify-center transition-all z-10 backdrop-blur-sm cursor-pointer shadow-lg"
              >
                ›
              </button>
            </div>
            ...
            <div className="p-8">
             <h3 className="text-3xl sm:text-4xl font-bold mt-2 mb-4 tracking-normal font-sans">
  {localizedName}
</h3>
              <p className="text-sm sm:text-base text-neutral-300 leading-relaxed min-h-[72px]">
                {localizedDesc}
              </p>
...
<div className="mt-4">
              <Link
                ...
                className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#15803d] hover:text-red-400 transition-colors"
              >
              ...
              <div className="mt-6 pt-4 border-t border-neutral-800 flex items-center justify-between text-xs text-neutral-400">
                <span className="font-semibold text-neutral-300">
                  {currentIndex + 1 < 10 ? `0${currentIndex + 1}` : currentIndex + 1} / {PROVINCES.length}
                </span>
          ...
          {/* БАРУУН ТАЛ */}
          <div className="lg:col-span-7 bg-white rounded-3xl p-4 sm:p-8 border border-gray-200/80 shadow-sm flex flex-col items-center justify-center">
            <div className="relative w-full max-w-[700px]">
              <svg viewBox="0 0 1000 520" className="w-full h-auto drop-shadow-md select-none">
                <image
                ...
                >
                  <circle r="26" fill="#15803d" opacity="0.3" className="animate-ping" />
                  <circle r="10" fill="#15803d" stroke="#ffffff" strokeWidth="3.5" />
...
>
            ...
            <div className="flex flex-wrap gap-1.5 justify-center mt-6 max-h-36 overflow-y-auto p-1">
